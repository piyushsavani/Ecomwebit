<div class="main-navbar shadow-sm sticky-top">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name">Akshar Ecom Website</h5>
                </div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ url('/orders') }}"><i class="fa fa-list"></i> My
                                        Orders</a></li>
                                <li><a class="dropdown-item" href="/wishlist"><i class="fa fa-heart"></i> My
                                        Wishlist</a></li>
                                <li><a class="dropdown-item" href="/cart"><i class="fa fa-shopping-cart"></i> My
                                        Cart</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="fashion">Fashions</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('appliances') }}">Appliances</a>
                    </li>
    ...
    <div class="container">
        @if(session('message'))
        <div style="color: orange; background-color: red" class="alert alert-danger"><b> {{ session('message') }} </b>
        </div>
        @endif
    </div>
</div>